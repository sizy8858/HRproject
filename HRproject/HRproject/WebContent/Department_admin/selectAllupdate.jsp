...
<hr>
<table border="1" width="90%" id="departments">
	<tr>
		<th>department_id</th>
		<th>location_id</th>
	...
	<c:forEach items="${dtos }" var="departmentsDto">	
		<tr>
			<td>${departmentsDto.employee_id}</td>
			<td>${departmentsDto.first_name}</td>        	      	
        	<td>${departmentsDto.last_name}</td>
        	<td><a href='/HRproject/Department/selectOne.departments?department_id=${departmentsDto.employee_id }'>${departmentsDto.email }</a></td> 
        	
		</tr>
	</c:forEach>
</table>
<a href="/HRproject/Employees/insert.jsp" class="btn">사원추가</a>
</body>
</html>