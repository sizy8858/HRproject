...
<a href="/HRproject/Employees/selectAll.employees" class="btn">목록가기</a>
<a href="/HRproject/Employees/update.employees?employee_id=${requestScope.dto.employee_id }" class="btn">수정하기</a>
<a href="/HRproject/Employees/delete.employees?employee_id=${requestScope.dto.employee_id }" class="btn">삭제하기</a>
</body>
</html>